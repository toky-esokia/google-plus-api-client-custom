 ...
 */
  ...
  class Google_Reports_ActivitiesServiceResource extends Google_ServiceResource {
    ...
    public function get($activityId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new Google_Plus_Activity($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class Google_Plus_CommentsServiceResource extends Google_ServiceResource {
    ...
    public function get($commentId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new Google_Plus_Comment($data);
      } else {
        return $data;
      }
    }
...
class Google_Plus_Acl extends Google_Model {
  public $description;
...
class Google_Plus_Activity extends Google_Model {
  ...
  public $url;
  public $verb;
  public function setAccess(Google_Plus_Acl $access) {
    $this->access = $access;
  }
  public function getAccess() {
    return $this->access;
  }
  public function setActor(Google_Plus_ActivityActor $actor) {
    $this->actor = $actor;
  }
...
class Google_Plus_ActivityActor extends Google_Model {
  public $displayName;
  public $id;
...
class Google_Plus_Comment extends Google_Model {
...
class Google_Plus_CommentInReplyTo extends Google_Model {
  public $id;
  public $url;
  public function setId( $id) {
    $this->id = $id;
